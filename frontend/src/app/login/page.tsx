...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      >
        <div className="absolute right-[12%] top-[12%] h-[520px] w-[520px] rounded-full bg-amber-600/[0.08] blur-[130px]" />
        <div className="absolute bottom-[8%] left-[5%] h-[420px] w-[420px] rounded-full bg-orange-600/[0.06] blur-[110px]" />
      </div>
